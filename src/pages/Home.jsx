...
export default function Home() {
  ...
  const totalSpending = useMemo(() => 
    previousMonths.reduce((total, [_, items]) => 
  ...
  if (isLoading) {
    return <div className="container section">Loading expenses...</div>;
  }
      ...
      <div className='card'>
        <h3 style={{ marginTop: 0 }}>
          ...
          <span className='muted'>
            (until {new Intl.DateTimeFormat(undefined,{timeZone:'Asia/Taipei'}).format(new Date(ongoingMonth.until))})
          </span>
        </h3>
        <div>
      ...
      <div className='card'>
        <h3 style={{ marginTop: 0 }}>
          ...
          {previousMonths.length > 0 && (
            <span className="muted" style={{ fontSize: '0.9em', marginLeft: '10px' }}>
        ...
        <div className='months'>
          ...
          {previousMonths.map(([ym, items]) => {
            const isSelected = selectedMonth === ym;
            const monthlyTotal = items.reduce((s, e) => s + Number(e.amount), 0);
            ...
            return (
              ...
              >
                ...
                <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                  ...
                  <Link to={`/month/${ym}`} onClick={(e) => e.stopPropagation()}>
